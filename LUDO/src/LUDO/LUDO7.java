...
import LUDO.LUDO7.Dice;
import LUDO.LUDO7.Position;
import LUDO.LUDO7.Player;
import LUDO.LUDO7.Player.Piece;

public class LUDO7 extends JPanel implements MouseListener {
	...
	public LUDO7(boolean capture) {
		this(capture, true);
	}

	public LUDO7(boolean capture, boolean limsix) {
	...
	public LUDO7(int sizeX, int sizeY, Color a, Color b, Color c, Color d, boolean capture, boolean limsix) {
