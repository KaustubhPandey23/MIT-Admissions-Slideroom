...
import LUDO.LUDO4.Dice;
import LUDO.LUDO4.Position;
import LUDO.LUDO4.Player;
import LUDO.LUDO4.Player.Piece;

public class LUDO4 extends JPanel implements MouseListener {
	...
	public LUDO4(boolean capture) {
		this(capture, true);
	}

	public LUDO4(boolean capture, boolean limsix) {
	...
	public LUDO4(int sizeX, int sizeY, Color a, Color b, Color c, Color d, boolean capture, boolean limsix) {
